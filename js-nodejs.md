...
- The `next` in `package-name@next` is a [git tag](https://stackoverflow.com/questions/40621566/what-package-version-does-next-specify-for-npm). It does not contain any magic.
